...
function ScriviData($quale_data = NULL, $lang = NULL){
	$quale_data = strftime ($GLOBALS["dateFormats"][$lang]["format_date"],$quale_data);
	return $quale_data;
}
function ScriviDataBreve($quale_data = NULL, $lang = NULL){
	$quale_data = strftime ($GLOBALS["dateFormats"][$lang]["format_dateBreve"],$quale_data);
	return $quale_data;
}
